...
#pragma clang diagnostic pop
    ...
    switch (postion) {
        case LXMImagePositionLeft:
            self.imageEdgeInsets = UIEdgeInsetsMake(0, -spacing/2 - 5, 0, spacing/2);
            self.titleEdgeInsets = UIEdgeInsetsMake(0, spacing/2 - 5, 0, -spacing/2);
            self.contentEdgeInsets = UIEdgeInsetsMake(0, spacing/2 - 5, 0, spacing/2);
            break;
